...
params:
  ...
  RB_Points: 0
  SN_Points: 0
  Map_Zoom_Level: 10 # Reference: Oswego, NY (12.75), Erie, PA (11.55), Buffalo, NY (10.45), North Tonawanda, NY (10.55), Sodus Bay, NY (11.10), Rochester, NY (9.95), Upper Niagara River, NY/ON (9.95), Black River Bay, NY (10.75)
---
...
HPL_sf_4326 = st_make_valid(HPL_sf_4326)
#summary(st_is_valid(HPL_sf_4326))

HPL_sf_3857 <- st_transform(HPL_sf, crs = 3857)
HPL_sf_3857 = st_make_valid(HPL_sf_3857)
#summary(st_is_valid(HPL_sf_3857))
...
Lake_sf_line <- st_read(here("./shapefiles/GL_Outline_old", "glgis_gl_shore_noaa_70k.shp")) 

Lake_sf_poly <- st_read(here("shapefiles/GL_Outline", "GreatLakesStLawrence.shp"))

Lake_sf_polyline <- st_cast(Lake_sf_poly, "MULTILINESTRING")

Lake_sf <- st_cast(Lake_sf_polyline, "LINESTRING")

Lake_sf_valid <- st_make_valid(Lake_sf)

Lake_sf <- st_cast(Lake_sf_valid, "LINESTRING")
