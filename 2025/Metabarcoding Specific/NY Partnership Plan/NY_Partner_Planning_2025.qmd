...
In 2025 the Lower Great Lakes Fish and Wildlife Conservation Office (LGLFWCO) is looking for partners to assist in metabarcoding sample collection. Locations requiring assistance along with number of samples to be collected by partners can be found in Table 1. Partners should review the tables and determine if they have capacity to assist and if any of the locations selected are of interest to their office for AIS or other species purposes. Data from samples collected by partners will be shared when data is available.
