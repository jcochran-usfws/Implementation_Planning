...
efta_tbl <- IP %>% 
  ...
  arrange(Basin) %>% 
  adorn_totals() %>% 
  filter(`Electrofish` > 0 | `Fyke Net` > 0 | `Gill Net` > 0 | `Metabarcoding` > 0) %>% 
